...
return [
    ...
    'help_sogo_joto' => [
        ...
        'html'  => ''
            ...
            . '<div class="help-text furu-help-note-hanging mb-0">※「譲渡所得の内訳書（確定申告書付表）【総合譲渡用】」で計算し、確定申告書と一緒に提出します。</div>'
            . '<div class="help-text furu-help-note-hanging mb-0">※土地や建物、借地権、株式等の譲渡から生じる所得は申告分離課税となります。この場合は申告書（第一表・第二表）と分離用（第三表）等を使用します。</div>'
            ...
            . '<div class="help-text furu-help-body mb-0">　短期譲渡：譲渡した資産の保有期間が５年以内のもの</div>'
            . '<div class="help-text furu-help-body mb-0">　長期譲渡：保有期間が５年を超えるもの</div>'
