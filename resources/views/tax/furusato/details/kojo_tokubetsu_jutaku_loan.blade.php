...
@endphp
<div class="container-blue mt-2" style="width: 900px;">
  <div class="card-header d-flex align-items-start">
    <img src="{{ asset('storage/images/kado_lefttop.jpg') }}" alt="…">
    <h0 class="mb-0 mt-2">住宅借入金等特別控除の内訳</h0>
  </div>
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('furusato.details.kojo_tokubetsu_jutaku_loan.save') }}">
      ...
      <hb class="card-title mb-2">所得税の控除限度額</hb>
      <div class="table-responsive mb-4">
        <table class="table-base table-bordered align-middle text-start">
          <tr>
            <th class="th-ccc" style="width:260px;">項目名</th>
            <th class="th-ccc" style="width:200px;">{{ $warekiPrevLabel }}</th>
            <th class="th-ccc" style="width:200px;">{{ $warekiCurrLabel }}</th>
          </tr>
          <tr>
            <th>借入金限度額</th>
            <td><input type="text" inputmode="numeric" class="form-control text-end js-comma" name="itax_borrow_cap_prev" value="{{ $sv('itax_borrow_cap_prev') }}"></td>
            <td><input type="text" inputmode="numeric" class="form-control text-end js-comma" name="itax_borrow_cap_curr" value="{{ $sv('itax_borrow_cap_curr') }}"></td>
          </tr>
          <tr>
            <th>借入金の年末残高</th>
            <td><input type="text" inputmode="numeric" class="form-control text-end js-comma" name="itax_year_end_balance_prev" value="{{ $sv('itax_year_end_balance_prev') }}"></td>
            <td><input type="text" inputmode="numeric" class="form-control text-end js-comma" name="itax_year_end_balance_curr" value="{{ $sv('itax_year_end_balance_curr') }}"></td>
          </tr>
          <tr>
            <th>控除率</th>
            <td>
      ...
      <hb class="card-title mb-2">住民税の控除限度額</hb>
      <div class="table-responsive mb-4">
        <table class="table-base table-bordered align-middle text-start">
          <tr>
            <th class="th-ccc" style="width:260px;">項目名</th>
          ...
          <tr>
            <th>課税総所得金額等×</th>
            <td>
              <select name="rtax_income_rate_percent_prev" class="form-select text-end" id="rate-prev">
            ...
            <td>
              <select name="rtax_income_rate_percent_curr" class="form-select text-end" id="rate-curr">
          ...
          <tr>
            <th>控除限度額</th>
            <td><input type="text" class="form-control text-end bg-light js-comma" name="rtax_carry_cap_prev" id="cap-prev" value="{{ $sv('rtax_carry_cap_prev') }}" readonly></td>
            <td><input type="text" class="form-control text-end bg-light js-comma" name="rtax_carry_cap_curr" id="cap-curr" value="{{ $sv('rtax_carry_cap_curr') }}" readonly></td>
          </tr>
        </table>
      </div>
