...
final class FurusatoSyoriRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pref_applied_rate_prev' => ['bail', 'required', 'numeric', 'min:0', 'max:100'],
            'pref_applied_rate_curr' => ['bail', 'required', 'numeric', 'min:0', 'max:100'],
            'muni_applied_rate_prev' => ['bail', 'required', 'numeric', 'min:0', 'max:100'],
            'muni_applied_rate_curr' => ['bail', 'required', 'numeric', 'min:0', 'max:100'],
