  ...
  <div class="card-body">
    <div class="wrapper">
      ...
      @endphp
        ...
        <hb class="mt-5 mb-3 ms-5">均等割・その他税額</hb>
        <table class="table-base table-bordered align-middle">
          <tbody>
              <tr style="height:23px;">
                <th style="width:110px;"></th>
                <th class="text-center" style="width:80px;">前期</th>
                <th class="text-center" style="width:80px;">当期</th>
              </tr>
              <tr>
                <th class="text-start ms-1">都道府県 均等割</th>
                <td>
              ...
              <tr>
                <th class="text-start ms-1">市区町村 均等割</th>
                <td>
                  <div class="d-flex align-items-center gap-1">
                    <input type="text"
              ...
              <tr>
                <th class="text-start ms-1">その他の税額</th>
                <td>
                  <div class="d-flex align-items-center gap-1">
                    <input type="text"
