  ...
  <div class="page-frame text-center">
    ...
    <table class="table b-none no-overlap"
      ...
      <tr>
        ...
        <table class="table table-compact-p14 ms-auto mb-5" style="width: 110mm;font-size:14px;line-height:1.7;">
          <tbody>
            <tr>
        ...
        <table class="table table-compact-p14 ms-auto mb-2" style="width: 110mm;font-size:14px;line-height:1.7;">
          <tbody>
            <tr>
    ...
    <div class="page-footer">
        <div class="footer-inner">
          <table class="table b-none no-overlap mb-0"
            ...
            <tr>
              <td class="text-end"><h14u>６ページ</h14u></td>
            </tr>
          </table>
        </div>
      </div>
