...
'kisokojo' => [
    ...
    'html'  => ''
        ...
        . '      <th style="background:#F7F9FB;">令和７・８年分</th>'
        . '      <th style="background:#F7F9FB;">令和９年分以降</th>'
        . '    </tr>'
        . '  </thead>'
        . '  <tbody>'
        . '    <tr>'
        . '      <td colspan="2" class="text-start nowrap">132万円以下</td>'
        . '      <td colspan="2" class="text-end nowrap">2,003,999円以下</td>'
        . '      <td colspan="2" class="text-center nowrap">95万円</td>'
        . '    </tr>'
        . '    <tr>'
        . '      <td class="text-start nowrap b-r-no">132万円超</td>'
        . '      <td class="text-end nowrap b-l-no">336万円以下</td>'
        . '      <td class="text-start nowrap b-r-no">2,003,999円超</td>'
        . '      <td class="text-end nowrap b-l-no">4,751,999円以下</td>'
