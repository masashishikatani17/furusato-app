...
return [
   'bunri_joto_tansho_choki' => [
        ...
        'html'  => ''
            ...
            . '  </tbody>'
            . '</table>'
            . '<div class="help-text furu-help-note-hanging ms-10 mb-1">(注1)譲渡先が国、地方公共団体等</div>'
            . '<div class="help-text furu-help-note-hanging ms-10 mb-1">(注2)譲渡先が国、地方公共団体等＋優良住宅地等のための譲渡</div>'
            . '<div class="help-text furu-help-note-hanging ms-10">(注3)譲渡した年の１月１日現在で所有期間が10年を超える居住用財産の譲渡</div>',
     ],
