...
<style>
  /* A4横 + 余白（上 右 下 左） */
      ...
      /* 2カラム：左120mm + ギャップ12mm + 右140mm = 272mm */
      .cols-grid{
        display: grid;
        grid-template-columns: 120mm 140mm;
  ...
  <div class="page-frame">
      ...
      <tr>
        <td class=" text-center b-l-no b-r-no">
          ...
          <div class="text-start ms-5 me-5 mt-3 mb-1">
            <h12>
              ※所得税は所得控除なので所得税の適用税率が高いと同じ寄附金であっても節税額が多くなります。そこで住民税の特例控除額を計算するに当たって適用される特例控除割合を小さ<br>&nbsp;&nbsp;&nbsp;くしているのです。所得税と住民税の節税額の合計は変わりません。
            </h12>
          </div>
        </td>
      </tr>
    ...
    <div class="cols-grid">
      ...
      <div class="col-box">
        ...
        <!-- 追加ブロック（左） -->
        <table align="center" class="g-table--none text-start table-120mm mt-5 ms-4">
          <colgroup>
      ...
      <div class="col-box ms-3">
        ...
        <table border="1" class="table text-start table-130mm ms-3 mt-3" style="font-size:12px;line-height:1.5;">
          <tbody>
            <tr>
        ...
        <table align="center" class="g-table--none text-start table-140mm ms-3 mt-5">
          <tbody>
            <tr>
    ...
    <div class="page-footer">
        <div class="footer-inner">
          <table class="table b-none no-overlap mb-0"
            ...
            <tr>
              <td class="text-end"><h14u>７ページ</h14u></td>
            </tr>
          </table>
        </div>
      </div>
