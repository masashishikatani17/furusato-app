...
@section('content')
  <div class="page-frame text-center"><!-- ここが実効幅281mmの中央寄せコンテナ -->
    ...
    <div style="width: 250mm; margin: 0 auto; display: flex; align-items: flex-start; gap: 10mm;">
      ...
      <!-- 左側：説明 -->
      <div class="table-frame" style="text-align: left;">
        <table align="center" class="table table-compact-p text-start no-overlap table-118mm" style="font-size:13px;line-height:1.6;">
          <colgroup>
      ...
      <!-- 右側テーブル -->
      <div>
        <div class="table-frame" style="flex: 1; margin-left: 4mm;">
          <table align="center" class="table table-compact-p text-start no-overlap table-119mm" style="font-size:13px;line-height:1.6;">
            <colgroup>
              <col style="width:11mm">
        ...
        <table class="table b-none no-overlap ms-5"
               style="width: 125mm; table-layout: fixed; border-collapse: collapse;
                      margin: 0 auto; clear:both;">
          <tr>
